      ...
      <div className="image-gallery">
        <div className="image-container">
          ...
          <div className="image-description">
            <a href="#">Select the right mortage</a>
          </div>
        </div>
        <div className="image-container">
          <img
        ...
        <div className="image-container">
          ...
          />
          <div className="image-description">
            <a href="#">see our savings products</a>
          </div>
        </div>
        <div className="image-container">
          <img
        ...
        <div className="image-container">
          ...
          />
          <div className="image-description">
            <a href="#">Login to Online Banking</a>
          </div>
        </div>
        </div>
      </div>
